...
function Register() {
  ...
  //   axios
  //     .post("http://127.0.0.1:8000/Customer_login/", user, {
  //       headers: {
  ...
  async function handleSubmit(e) {
    ...
    try {
      console.log("error 1");
      let result = await fetch("http://127.0.0.1:8000/Customer_login", {
        method: "POST",
        mode: "no-cors",
        headers: {
              ...
              <form>
                ...
                <div class="text-center lg:text-left">
                  ...
                  <p class="text-sm font-semibold mt-2 pt-1 mb-0">
                    ...
                    <Link to={`/SignUp/`}>
                      <a class="text-red-600 hover:text-red-700 focus:text-red-700 transition duration-200 ease-in-out ml-4">
                        Register
                      </a>
                    </Link>
                  </p>
